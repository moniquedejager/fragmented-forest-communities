...
write_data_to_files_similar_dispersal <- function(rv){
  #library(ggplot2)
  ...
  df <- data.frame(mu         = rv$clustering,
                   ...
                   METE_fit   = fit[landscape[(landscape[,iFrag] == 1),20]==1],
                   Pm         = Pm[landscape[(landscape[,iFrag] == 1),20]==1],
  ...
  filename <- paste('./results/simulation results 04-2024/subcommunity_data/subcommunity_data_',
                    rv$sim_nr, 'similar_dispersal.txt', sep='')
  ...
  filename <- paste('./results/simulation results 04-2024/community_composition/',
                    ...
                    '_', rv$mutation_rate,'_', rv$max_mutation,'similar_dispersal.txt', sep='')
