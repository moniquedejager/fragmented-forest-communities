...
cbp1 <- c( "#6E2C00", "#307314", "#E69F00", "#999999", "#009E73")
...
ggplot(sdf, aes(x=f_loss*100, y=n_species, fill=type)) + 
...
ggplot(sdf, aes(x=f_loss*100, y=Pm, fill=type)) + 
  geom_bar(stat='identity', position=position_dodge(10), 
           just=0.9, width=10, color='black') + 
  scale_fill_manual(values=cbp1, name='') + 
  facet_wrap(vars(mu2)) + 
...
ggplot(sdf, aes(x=f_loss*100, y=dissimilarity, fill=type)) + 
  geom_bar(stat='identity', position=position_dodge(10), 
           just=0.9, width=10, color='black') + 
  scale_fill_manual(values=cbp1, name='') + 
  facet_wrap(vars(mu2)) + 
