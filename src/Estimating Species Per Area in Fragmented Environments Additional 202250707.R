...
params <- expand.grid(N0 = seq(300000, 600000, 10000),
                      S0 = seq(30000, 50000, 1000))
...
for (i in 1:nrow(params)){
  print(paste(round(i/nrow(params)*100, 1), '% progress'))
  sar <- meteSAR(Amin=1, 
                  A0=2025, 
                  S0=params$S0[i], 
                  N0=params$N0[i]) 
...
write.table(sars, 'Fragmented-forest-communities/x64/Release/results/SARs_additional.txt', 
